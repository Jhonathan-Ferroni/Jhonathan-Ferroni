<h1>
  <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Animals/Spider.png" width="35" height="35" />
...
<p align="justify">
Sou <b>Desenvolvedor de Software</b> focado no ecossistema <b>.NET</b> e estudante de Análise e Desenvolvimento de Sistemas. Tenho experiência prática no desenvolvimento de aplicações backend robustas utilizando <b>C#</b>, <b>ASP.NET Core</b> e bancos de dados relacionais, aplicando conceitos de arquitetura limpa, testes e autenticação segura (JWT).

Além do foco no backend, possuo conhecimentos em <b>React</b> e JavaScript, o que me permite transitar pelo frontend, construir interfaces dinâmicas e integrar APIs de ponta a ponta. Busco uma oportunidade como <b>Desenvolvedor C# / .NET Júnior</b> para aplicar boas práticas de desenvolvimento e contribuir com soluções eficientes.
</p>
...
- 🚀 **Backend com .NET:** Criação de APIs REST eficientes utilizando ASP.NET Core (MVC e Minimal APIs), Entity Framework Core e segurança via JWT.
- 🌐 **Frontend com React:** Desenvolvimento de SPAs (Single Page Applications) dinâmicas, consumo de APIs assíncronas e gerenciamento de estado.
- 🗄️ **Banco de Dados:** Modelagem relacional, escrita de queries complexas, Stored Procedures e Functions em SQL Server e MySQL.
- ⚙️ **Boas Práticas:** Código limpo (Clean Code), princípios SOLID, Programação Orientada a Objetos (POO) e controle de versão com Git.
